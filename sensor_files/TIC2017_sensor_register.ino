...
#define DeviceName "Telsta2017IC Device"

const char host[] = "tic2017team045.iot.telstra.com";
const char tenant[] = "tic2017team045";
const char username[] = "device";
const char password[] = "trust^CENTS^115";
const char appkey[] = ""; 
